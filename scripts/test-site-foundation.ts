...
assert.match(
  dashboard,
  /siteId === 'site-cannon-falls' \|\| siteId === 'site-salinas'[\s\S]*controller-connection-path-title/,
  'Cannon Falls and Salinas must display the independent controller connection path.'
);
