...
assert.ok(page.includes('/images/generated/blast60-capacity-neutral.png'), "Capacity comparison graphic must remain on the page");
assert.ok(existsSync("public/images/generated/blast60-capacity-neutral.png"), "Capacity comparison asset must exist");
