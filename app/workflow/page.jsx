        ...
        <section className="card mt">
          ...
          <div className="feature-grid">
            <article className="card">
              <h3><span className="icon-chip"><i data-lucide="thermometer-snowflake"></i></span>1. Chill Ethanol</h3>
              <p>Ethanol is chilled to -40°C/F.</p>
            </article>
            <article className="card">
              <h3><span className="icon-chip"><i data-lucide="circle-dot-dashed"></i></span>2. Pump Ethanol</h3>
              <p>The chilled ethanol is pumped by the Perma Cool pump to fill the centrifuge.</p>
            </article>
            <article className="card">
              <h3><span className="icon-chip"><i data-lucide="drum"></i></span>3. Process Biomass</h3>
              <p>The centrifuge processes the biomass using the chilled ethanol.</p>
            </article>
            <article className="card">
              <h3><span className="icon-chip"><i data-lucide="beaker"></i></span>4. Extract Tincture Solution</h3>
              <p>The ethanol, now called the &quot;tincture solution,&quot; is spun out of the centrifuge.</p>
            </article>
            <article className="card">
              <h3><span className="icon-chip"><i data-lucide="arrow-right-left"></i></span>5. Pump Tincture Solution</h3>
              <p>A diaphragm pump moves the tincture solution out of the centrifuge.</p>
            </article>
            <article className="card">
              <h3><span className="icon-chip"><i data-lucide="funnel"></i></span>6. Filter Biomass</h3>
            ...
            <article className="card">
              <h3><span className="icon-chip"><i data-lucide="badge-alert"></i></span>7. Return and Rechill</h3>
            ...
            <article className="card">
              <h3><span className="icon-chip"><i data-lucide="infinity"></i></span>8. Repeat</h3>
