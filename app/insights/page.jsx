    ...
    <>
      <section className="container section">
        ...
        <div className="feature-grid">
          ...
          <article className="card"><h3><span className="icon-chip"><i data-lucide="git-branch"></i></span>Perma Cool Ethanol Pre-Chiller Workflow</h3><p>Step-by-step extraction flow plus the electric advantage over LN2-heavy chilling.</p><a href="/perma-cool-ethanol-pre-chiller-workflow">Read article →</a></article>
