    ...
    <>
      ...
      <section className="container section pt0 process-visual-section">
        ...
        <div className="process-steps clean-process-steps">
          ...
          <article className="card"><h3><span className="icon-chip"><i data-lucide="refresh-cw"></i></span>03 • Rinse & Repeat</h3><p>Integrated cooling architecture supports high-duty production and lower consumable dependency.</p><a href="/workflow">See the workflow →</a></article>
        </div>
      </section>
