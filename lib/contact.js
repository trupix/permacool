export const CONTACT_SUPPORT_OPTIONS = ["Extraction Chiller Support - Basic", "Extraction Chiller Support - Agentic"];
export const CONTACT_INTERESTS = ["Ethanol Chillers", "Butane Recovery Systems", "Both", "Lab Process Chillers", ...CONTACT_SUPPORT_OPTIONS];
...
export const CONTACT_PRODUCTS = ["BLAST 60/45", "BLAST 150/45", "BLAST 150/30", "BLAST 240/45", "Butane Recovery System", "PERMA Lab Process"];
...
export function buildContactSubmissionAction({ interest, coolingMethod, requestType, product, source } = {}) {
  const params = new URLSearchParams();
