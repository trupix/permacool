    ...
    "@graph": [
      {
        ...
        description: "Purpose-built cooling systems for laboratory processes and botanical extraction.",
        foundingDate: "2018",
        founder: {
          "@type": "Person",
          name: "David Schaefer"
        ...
        knowsAbout: [
          ...
          "Split-system laboratory process cooling",
          "Remote condenser lab chillers"
        ],
        subjectOf: {
          "@type": "Article",
      ...
      },
      {
        ...
        url: SITE_URL,
        name: SITE_NAME,
        description: "Extraction chillers, split-system laboratory process cooling, and practical cooling education.",
